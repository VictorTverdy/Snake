...
namespace AppAdvisory.DancingSnake
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1A5j2VE34IvbZ5_GvO0Ln5_hs_TJB-GGvYcDwk0I5BcA/";
		private const string RATEUS_URL = "http://u3d.as/UsT";

		private const string NAME_OF_THE_GAME = "Dancing Snake";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
